...
def build_sinusoidal_pe(max_len: int, d_model: int) -> torch.Tensor:
    """Build sinusoidal positional encoding tensor.
    ...
    Returns:
        Tensor of shape (max_len, d_model) with sinusoidal encodings.
    """
...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int, max_seq_length: int = 5000, dropout: float = 0.1) -> None:
        ...
        self.register_buffer("pe", build_sinusoidal_pe(max_seq_length, d_model))
