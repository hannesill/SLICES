...
Example usage:
    ...
    python scripts/convert_csv_to_parquet.py data.csv_root=/path/to/csv data.parquet_root=/path/to/parquet
"""
...
def main(cfg: DictConfig) -> None:
    ...
    if csv_root_str is None:
        ...
        print("Example: python scripts/convert_csv_to_parquet.py data.csv_root=/path/to/mimic-iv-csv")
    ...
    if success:
        ...
        print(f"  python scripts/extract_mimic_iv.py")
    else:
